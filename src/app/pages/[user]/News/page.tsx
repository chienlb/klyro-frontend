                ...
                <section className="bg-gray-50 py-12 border-b border-gray-100">
                    <div className="max-w-7xl mx-auto px-6">
                        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
                            Tin tức & <span className="text-[#F26076]">Kinh nghiệm</span>
                        </h1>
                    ...
                    <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="flex-1">
                                ...
                                <div className="relative rounded-3xl overflow-hidden h-96 mb-6">
                                    ...
                                    <div className="absolute bottom-0 left-0 p-8 w-full">
                                        <div className="flex items-center gap-3 mb-4">
                                            <span className="px-3 py-1 bg-[#F26076] text-white text-xs font-bold rounded-md uppercase tracking-wider shadow-sm">Tin nổi bật</span>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
                                {[
                                    ...
                                    <div key={idx} className="group cursor-pointer flex flex-col h-full">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#F26076] transition-colors line-clamp-2 leading-snug">{news.title}</h3>
                                        <p className="text-gray-600 line-clamp-2 mb-4 flex-grow">{news.excerpt}</p>
                                        <div className="text-[#F26076] font-bold text-sm flex items-center gap-1 group-hover:gap-2 transition-all mt-auto">
                            ...
                            <div className="mt-16 flex justify-center gap-2">
                                ...
                                <button className="w-10 h-10 rounded-xl bg-[#F26076] text-white font-bold flex items-center justify-center shadow-md shadow-red-200">1</button>
                        ...
                        <div className="w-full lg:w-80 flex-shrink-0 space-y-10">
                            ...
                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                ...
                                <div className="relative">
                                    <input 
                                        type="text" 
                                        className="w-full pl-4 pr-10 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#F26076] transition-all" 
                                        placeholder="Nhập từ khóa..."
                                    />
                                    <button className="absolute inset-y-0 right-3 flex items-center text-gray-400 hover:text-[#F26076]">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {['Kinh nghiệm HSK', 'Từ vựng', 'Ngữ pháp', 'Du học', 'Giao tiếp', 'Văn hóa', 'Review sách'].map((tag, idx) => (
                                        <Link key={idx} href="#" className="px-3 py-1.5 bg-gray-50 hover:bg-[#F26076] hover:text-white text-gray-600 text-sm font-medium rounded-lg transition-colors border border-gray-100 hover:border-transparent">
                                            {tag}
                                        </Link>
                                    ))}
                                </div>
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div key={idx} className="flex gap-4 group cursor-pointer">
                                            <div className="text-[#F26076] font-black text-2xl opacity-40 group-hover:opacity-100 transition-opacity w-6">
                                                0{idx+1}
                                            </div>
                                            <div>
                                                <h4 className="text-gray-900 font-bold text-sm mb-1 group-hover:text-[#F26076] transition-colors leading-tight">{post.title}</h4>
                            ...
                            {/* CTA Banner */}
                            <div className="bg-gradient-to-br from-[#F26076] to-[#ff7a8e] rounded-2xl p-6 text-white text-center shadow-lg shadow-red-200">
