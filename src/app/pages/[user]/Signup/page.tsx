            ...
            <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-24 py-12 bg-white">
                <div className="mx-auto w-full max-w-md">
                    <div className="mb-10 text-center md:text-left">
                        ...
                        <p className="text-gray-500">Trải nghiệm 3 ngày học miễn phí không cần thẻ tín dụng</p>
                    </div>
                    ...
                    <div className="mt-8 flex items-center gap-4">
                        ...
                        <span className="text-sm text-gray-400 font-medium">Hoặc đăng ký với</span>
                        <div className="flex-1 h-px bg-gray-200"></div>
                    </div>
