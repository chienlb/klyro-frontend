                ...
                <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white pt-20 pb-24">
                    <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
                        <div className="flex-1 text-center md:text-left">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 text-[#D95375] font-medium text-sm mb-6">
                                <SparklesIcon className="w-5 h-5" />
                                <span>Luyện phát âm chuẩn bản xứ</span>
                            </div>
                            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-6">
                                Nắm vững Pinyin <br />
                                <span className="text-[#e87391]">tự tin giao tiếp</span>
                            </h1>
                        ...
                        <div className="flex-1 w-full relative mt-10 md:mt-0 flex justify-center">
                            <div className="w-64 h-64 bg-[#e87391] rounded-full flex items-center justify-center relative shadow-2xl shadow-[#e87391]/30 group">
                                                ...
                                                <div key={syllable} className={`text-center py-4 rounded-xl transition-all min-w-[60px] md:min-w-[80px] flex items-center justify-center ${isValid ? 'bg-white border border-gray-200 hover:border-blue-400 hover:shadow-md cursor-pointer group' : 'bg-gray-100 text-transparent'}`}>
                                                    {isValid && (
                                                        <div className="flex flex-col items-center justify-center gap-1">
                                                            <span className="text-gray-800 text-lg group-hover:text-[#D95375] font-medium">{syllable}</span>
                                                            <SpeakerWaveIcon className="w-3 h-3 text-gray-400 group-hover:text-[#e87391] opacity-0 group-hover:opacity-100 transition-opacity" />
                                                        </div>
                                                    )}
                                                </div>
                                            )
                            ...
                            {[
                                ...
                                <div key={idx} className="bg-white rounded-3xl p-8 text-center border border-gray-100 hover:shadow-xl transition-shadow relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10">
                                        <div className="w-16 h-16 mx-auto bg-blue-100 rounded-2xl flex items-center justify-center text-[#D95375] font-bold text-2xl mb-4">
                                            {tone.symbol}
                                        </div>
                                        <h3 className="text-xl font-bold text-gray-900 mb-1">{tone.name}</h3>
                                        <p className="text-4xl font-bold text-[#e87391] my-4">{tone.pinyin}</p>
                                        <p className="text-sm text-gray-500 mb-6">{tone.desc}</p>
                                        <button className="w-full py-3 bg-gray-50 rounded-xl flex items-center justify-center gap-2 hover:bg-[#e87391] hover:text-white transition-colors text-gray-700 font-medium group/btn">
