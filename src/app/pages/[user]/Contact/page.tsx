            ...
            <main className="flex-grow">
                ...
                <section className="relative h-64 md:h-96 bg-gray-900 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-10 p-6">
                        <div className="w-16 h-16 bg-[#D95375] text-white rounded-full flex items-center justify-center mb-4 shadow-lg shadow-red-500/40 animate-bounce" style={{ animationDuration: '3s' }}>
                        ...
                        <div className="flex flex-col lg:flex-row gap-10">
                                ...
                                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl shadow-gray-200/50 flex-1">
                                    ...
                                    <div className="space-y-8">
                                        <div className="flex gap-4 group">
                                            <div className="w-12 h-12 rounded-2xl bg-red-50 text-[#D95375] flex items-center justify-center flex-shrink-0 group-hover:bg-[#D95375] group-hover:text-white transition-colors">
                                        ...
                                        <div className="flex gap-4 group">
                                            <div className="w-12 h-12 rounded-2xl bg-blue-50 text-[#e87391] flex items-center justify-center flex-shrink-0 group-hover:bg-[#e87391] group-hover:text-white transition-colors">
                                    ...
                                    <div className="mt-12 pt-8 border-t border-gray-100">
                                        ...
                                        <div className="flex gap-3">
                                            <Link href="https://facebook.com" className="w-10 h-10 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center hover:bg-[#D95375] hover:text-white transition-colors shadow-sm">
                                            ...
                                            <Link href="https://youtube.com" className="w-10 h-10 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center hover:bg-[#D95375] hover:text-white transition-colors shadow-sm">
                                            ...
                                            <Link href="https://github.com" className="w-10 h-10 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center hover:bg-[#D95375] hover:text-white transition-colors shadow-sm">
                            ...
                            <div className="flex-1 bg-white rounded-3xl p-8 md:p-12 border border-gray-100 shadow-xl shadow-gray-200/50">
                                <div className="flex items-center gap-3 mb-2">
                                    <ChatBubbleBottomCenterTextIcon className="w-8 h-8 text-[#D95375]" />
                                ...
                                <form className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input 
                                                type="text" 
                                                className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#D95375] focus:border-transparent transition-all" 
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#D95375] focus:border-transparent transition-all text-gray-600">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea 
                                            rows={5}
                                            className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#D95375] focus:border-transparent transition-all resize-none" 
                                            placeholder="Hãy mô tả chi tiết vấn đề bạn đang gặp phải..."
                                        ></textarea>
                                    </div>
                                    
                                    <button type="button" className="w-full md:w-auto px-10 py-4 bg-gray-900 text-white font-bold rounded-xl hover:bg-[#D95375] transition-colors flex items-center justify-center gap-2 shadow-lg hover:-translate-y-1">
