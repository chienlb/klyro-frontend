            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li><Link href="/" className="text-gray-500 hover:text-[#D95375] transition-colors text-sm">Giao tiếp cơ bản</Link></li>
                        <li><Link href="/" className="text-gray-500 hover:text-[#D95375] transition-colors text-sm">Luyện thi HSK 1-3</Link></li>
                        <li><Link href="/" className="text-gray-500 hover:text-[#D95375] transition-colors text-sm">Luyện thi HSK 4-6</Link></li>
                        <li><Link href="/" className="text-gray-500 hover:text-[#D95375] transition-colors text-sm">Tiếng Trung thương mại</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li><Link href="/" className="text-gray-500 hover:text-[#D95375] transition-colors text-sm">Tài liệu miễn phí</Link></li>
                        <li><Link href="/" className="text-gray-500 hover:text-[#D95375] transition-colors text-sm">Hướng dẫn học</Link></li>
                        <li><Link href="/" className="text-gray-500 hover:text-[#D95375] transition-colors text-sm">Câu hỏi thường gặp</Link></li>
                        <li><Link href="/" className="text-gray-500 hover:text-[#D95375] transition-colors text-sm">Liên hệ</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex gap-4">
                        <Link href="https://facebook.com" className="w-10 h-10 rounded-full bg-gray-200 hover:bg-[#D95375] hover:text-white flex items-center justify-center transition-colors cursor-pointer text-gray-500">
                        ...
                        <Link href="https://youtube.com" className="w-10 h-10 rounded-full bg-gray-200 hover:bg-[#D95375] hover:text-white flex items-center justify-center transition-colors cursor-pointer text-gray-500">
                        ...
                        <Link href="https://github.com" className="w-10 h-10 rounded-full bg-gray-200 hover:bg-[#D95375] hover:text-white flex items-center justify-center transition-colors cursor-pointer text-gray-500">
